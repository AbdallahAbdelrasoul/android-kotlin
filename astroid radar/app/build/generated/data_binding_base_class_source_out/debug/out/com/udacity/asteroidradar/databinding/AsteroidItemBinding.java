...
public abstract class AsteroidItemBinding extends ViewDataBinding {
  ...
  @NonNull
  public final ImageView dangerOrSafe;

  @Bindable
  protected Asteroid mAsteroid;

  @Bindable
  protected MainListAdapter.Companion.AsteroidListener mClickListener;

  protected AsteroidItemBinding(Object _bindingComponent, View _root, int _localFieldCount,
      TextView closeApproachDate, TextView codename, ImageView dangerOrSafe) {
    super(_bindingComponent, _root, _localFieldCount);
    this.closeApproachDate = closeApproachDate;
    this.codename = codename;
    this.dangerOrSafe = dangerOrSafe;
  }
  ...
  public abstract void setClickListener(
      @Nullable MainListAdapter.Companion.AsteroidListener clickListener);

  @Nullable
  public MainListAdapter.Companion.AsteroidListener getClickListener() {
